...
#define mainDISPLAY_TASK_PRIORITY               ( OS_TASK_PRIORITY_HIGHEST )
#define mainFLASH_TASK_PRIORITY                 ( OS_TASK_PRIORITY_NORMAL )
#define mainLIS3DH_TASK_PRIORITY                ( OS_TASK_PRIORITY_LOWEST )
#define mainTOUCH_TASK_PRIORITY                 ( OS_TASK_PRIORITY_NORMAL )

#define CFG_GPIO_I2C1_SCL_PORT          (HW_GPIO_PORT_3)
#define CFG_GPIO_I2C1_SCL_PIN           (HW_GPIO_PIN_7)
...
static OS_TASK handle1;
static OS_TASK handle2;
static OS_TASK handle3;
static OS_TASK handle4;
/*
 * Wakeup handler
 */
...
static void periph_init(void)
{
        ...
        //Display Reset
        hw_gpio_set_pin_function(HW_GPIO_PORT_4, HW_GPIO_PIN_7, HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO);
        hw_gpio_set_active(HW_GPIO_PORT_4,HW_GPIO_PIN_7);

        //Vibration
        hw_gpio_set_pin_function(HW_GPIO_PORT_1, HW_GPIO_PIN_0, HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_GPIO);
        ...
        //-----I2C port/pin config ------P3.7=SCL, P3.5=SDA--------
        hw_gpio_configure_pin(CFG_GPIO_I2C1_SCL_PORT,CFG_GPIO_I2C1_SCL_PIN, HW_GPIO_MODE_OUTPUT, HW_GPIO_FUNC_I2C_SCL,false);
        hw_gpio_configure_pin(CFG_GPIO_I2C1_SDA_PORT,CFG_GPIO_I2C1_SDA_PIN, HW_GPIO_MODE_INPUT, HW_GPIO_FUNC_I2C_SDA,false);

#ifdef DEVKIT_USB
        hw_gpio_configure_pin(HW_GPIO_PORT_3, HW_GPIO_PIN_1, HW_GPIO_MODE_INPUT_PULLUP, HW_GPIO_FUNC_GPIO, true);
        hw_gpio_configure_pin(HW_GPIO_PORT_1, HW_GPIO_PIN_4, HW_GPIO_MODE_INPUT_PULLDOWN, HW_GPIO_FUNC_GPIO, true);
        //led
