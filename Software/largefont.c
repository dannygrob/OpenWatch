...
int displayDrawClockNumber(int X_START, int Y_START, char CHARACTER) {
        ...
        int letterWidth = displayGetWidthClockCharacter(CHARACTER);
        int row = 0;
        int column = 0;
        ...
        displayPartialImageFromMemory(X_START,Y_START,(column - 1) * CLOCK_FONT_CHARACTER_WIDTH , (row - 1) * CLOCK_FONT_CHARACTER_HEIGHT,CLOCK_FONT_CHARACTER_WIDTH,CLOCK_FONT_CHARACTER_HEIGHT,CLOCKFONT_OFFSET);
        return letterWidth;
}
